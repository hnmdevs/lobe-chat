...
const errorMap = {
  [ErrorEnum.Configuration]:
    'Wrong configuration, make sure you have the correct environment variables set. Visit https://imoogleai.xyz/docs/self-hosting/advanced/authentication for more details.',
