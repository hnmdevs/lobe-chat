...
export const GITHUB = 'https://github.com/hnmdevs/lobe-chat';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://imoogleai.xyz/changelog';
export const DOCKER_IMAGE = 'https://hub.docker.com/r/hnmdevs/lobe-chat';
...
export const FEEDBACK = 'https://github.com/hnmdevs/lobe-chat/issues/new/choose';
...
export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/hnmdevs/lobe-chat/discussions/6157';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/hnmdevs/lobe-chat/discussions/3684';

export const AGENTS_INDEX_GITHUB = 'https://github.com/hnmdevs/lobe-chat-agents';
